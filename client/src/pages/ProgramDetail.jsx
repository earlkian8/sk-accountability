  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--gray-50)' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px', height: 56, display: 'flex', alignItems: 'center', gap: 14 }}>
      ...
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '28px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>

        {/* ── Title card ── */}
        <div className="surface slide-up" style={{ padding: 28 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8, marginBottom: 16 }}>
            <StatusBadge status={live.status} />
            <CategoryTag category={live.category} />
          </div>

          <h1 className="heading" style={{ fontSize: 26, color: 'var(--gray-900)', marginBottom: 14, lineHeight: 1.25 }}>
            {live.name}
          </h1>
        ...
        {live.photoUrl ? (
          ...
          <div className="surface slide-up d1" style={{ height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: 'var(--blue-pale)', borderStyle: 'dashed' }}>
        ...
        <div className="surface slide-up d2" style={{ padding: 24 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 18 }}>
            ...
            <div style={{ background: 'var(--green-light)', border: '1px solid #bbf7d0', borderRadius: 'var(--radius)', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <div style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 32, color: 'var(--green)', lineHeight: 1 }}>{live.verifications}</div>
            ...
            <div style={{ background: 'var(--red-light)', border: '1px solid #fecaca', borderRadius: 'var(--radius)', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 14 }}>
              ...
              <div>
                <div style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 32, color: 'var(--red)', lineHeight: 1 }}>{live.flags}</div>
          ...
          <div style={{ background: 'var(--blue-pale)', border: '1px solid var(--blue-light)', borderRadius: 'var(--radius-sm)', padding: '10px 14px', marginBottom: 18, display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
            <span style={{ fontSize: 12, color: 'var(--blue)', fontWeight: 600 }}>
              ✓ 3+ verifications → Community Verified
            </span>
            <span style={{ color: 'var(--gray-300)' }}>·</span>
            <span style={{ fontSize: 12, color: 'var(--red)', fontWeight: 600 }}>
              ! 2+ flags → Flagged para sa imbestigasyon
            </span>
          </div>
